...
class DownloadPresenceChecker:
    ...
    def _validate_era5(self):
        ...
        has_data = self.download_registry.has_data(era5_dir, kind="nc")
        self.status.append(
            SourceStatus(
    ...
    def _validate_co2(self):
        ...
        has_data = self.download_registry.has_data(co2_dir, kind="nc")
        self.status.append(
            SourceStatus(
    ...
    def _validate_wtd(self):
        ...
        has_data = self.download_registry.has_data(wtd_dir, kind="tif")
        self.status.append(
            SourceStatus(
